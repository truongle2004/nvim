...
vim.keymap.set("v", "<leader>l", "$y<cr>")
vim.keymap.set("n", "<leader>sc", ":source %<cr>")
vim.keymap.set("n", "<leader>go", ":TSToolsOrganizeImports<CR>")
vim.keymap.set("n", "<leader>gi", ":TSToolsAddMissingImports<CR>")
-- Disable yank on delete (d, D, x) in normal/visual mode
...
-- Disable yank on change (c, C) in normal/visual mode
vim.keymap.set("n", "c", '"_c', { noremap = true, silent = true })
vim.keymap.set("n", "C", '"_C', { noremap = true, silent = true })
vim.keymap.set("v", "c", '"_c', { noremap = true, silent = true })

-- Prevent paste from overwriting the yank buffer in visual mode
vim.keymap.set("x", "p", '"_dP', { noremap = true, silent = true })
vim.keymap.set("n", "<leader>rs", ":source ~/.config/nvim/init.lua<cr>")
vim.keymap.set("t", "<C-x>", [[<C-\><C-n>]], { noremap = true, silent = true })
vim.keymap.set("n", "<F3>", ":set spell! spell?<CR>", { noremap = true, silent = true })
vim.keymap.set("n", "<leader>rq", ":cfdo %s///g | update | bd")
vim.keymap.set("n", "<leader>te", ":sp | term<CR>", { noremap = true, silent = true })
