...
require("lazy").setup({
    ...
    config = function()
      ...
      lspconfig.pylsp.setup({
        ...
        on_init = function(client)
          if not pylsp_restarted then -- Only proceed if we haven't restarted yet
  ...
  },
  {
    ...
    config = function()
      -- color for cmp background
      -- vim.api.nvim_set_hl(0, "CmpNormal", { bg = "#808080" })
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader><leader>f", function() Snacks.picker.grep() end,                                    desc = "Grep" },
...
-- map("n", "<leader>rn", ":lua require('./lua/deepseek')")
